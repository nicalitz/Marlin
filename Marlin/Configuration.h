...
// Included for compatibility with PlatformIO
#include "macros.h"
...
#define STRING_CONFIG_H_AUTHOR "(nicalitz)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "ANYCUBIC"         // will be shown during bootup in line 2
 ...
 */
// ! Standard baudrate from Marlin Anycubic Kossel template = 115200
...
// ? Could maybe use this UUID for Octoprint setup
#define MACHINE_UUID "a0b10b85-422b-4ff2-a3cb-501061d14df2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // ! This should be hard coded after calibration
 ...
 */
#if ANYCUBIC_KOSSEL_ENABLE_BED > 0
  // ! This is enabled in template. Note sure if it will work with external FET
  // ! Consider turing back on for test
  // #define PIDTEMPBED
#endif
...
#define DELTA
// TODO: Verify and fine tune all parameter in this section
  ...
  #define DELTA_CALIBRATION_MENUc
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS DELTA_PRINTABLE_RADIUS * 0.7
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 101.21 //mm  Get this value from auto calibrate
  #endif

  // height from z=0 to home position
  #define DELTA_HEIGHT 330.61 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.00, -1.63, -0.38 } // get these from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.08, +0.22, -0.14 } // get these values from auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
// ! default: { 3000, 3000, 3000, 3000 }
#define DEFAULT_MAX_ACCELERATION       { 900, 900, 900, 3000 }
 ...
 */
// ! This is enabled by default. Make sure it works as intended
...
#else
  // ! Value with broken tip. Update as necessary (template default = -16.8)
...
// ! set INVERT_E0_DIR to true for A4988 drivers
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // TODO: fine tune these limits
  #define PROBE_MARGIN 20
  #define LEFT_PROBE_BED_POSITION -((DELTA_PRINTABLE_RADIUS - PROBE_MARGIN) -(MIN_PROBE_EDGE))
  #define RIGHT_PROBE_BED_POSITION (DELTA_PRINTABLE_RADIUS - PROBE_MARGIN) -(MIN_PROBE_EDGE)
  #define FRONT_PROBE_BED_POSITION -((DELTA_PRINTABLE_RADIUS - PROBE_MARGIN) -(MIN_PROBE_EDGE))
  #define BACK_PROBE_BED_POSITION (DELTA_PRINTABLE_RADIUS - PROBE_MARGIN) -(MIN_PROBE_EDGE)
