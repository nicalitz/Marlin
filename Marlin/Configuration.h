...
// ? changed the _Bootscreen.h file from decimal to binary. Can now see the logo
...
#define MACHINE_UUID "dc8a7eec-b8b0-48fa-9d71-2e4894e59e07"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // ! default values from Tevo's official Github page
  #define DEFAULT_Kp 13.33  // official: 20.37
  #define DEFAULT_Ki 1.06   // official: 1.50
  #define DEFAULT_Kd 41.77  // official: 69.26
 ...
 */
// ! disabled on default firmware, enabled on Tevo's official firmware
// #define PIDTEMPBED
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // ! default values from Tevo's official Github page
  #define DEFAULT_bedKp 128.82  // facebook: 44.00
  #define DEFAULT_bedKi 16.91   // facebook: 7.36
  #define DEFAULT_bedKd 245.36  // facebook: 65.78
...
// ! X, Y, Z min endstops set to true on Tevo's official firmware
 ...
 */
// ! default: { 80, 80, 4000, 500}
// TODO: This is ~400 in firmware from facebook group. Double check
// TODO: From facebook group: { 80.3190, 80.3190, 399.2901, 400 }
...
// ! INVERT_E0_DIR set to true in Tevo's official firmware
...
// ? Z_MAX_POS=400 for Tevo's official firmware
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // TODO: probably need to enable these
...
#define HOMING_FEEDRATE_XY (50*60)  // ! tevo official: (60*60)
#define HOMING_FEEDRATE_Z  (4*60)   // ! tevo official: (8*60)
...
// Preheat Constants
// TODO: PREHEAD_1_FAN_SPEED=0 in official firmware. Confirm this
 ...
 */
// TODO: Check this out maybe. Enabled in a Facebook group version
...
//
// ! enabled on official firmware. shouldn't be necessary
